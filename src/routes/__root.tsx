...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "O primeiro robô de vendas com IA focado em resultados reais. Transforme cliques em campanhas profissionais sem promessas vazias. Estabilidade e lucro de verdade." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "RoboVendas.IA — Robô de Vendas Automáticas com IA para Vida Real" },
      { name: "twitter:description", content: "O primeiro robô de vendas com IA focado em resultados reais. Transforme cliques em campanhas profissionais sem promessas vazias. Estabilidade e lucro de verdade." },
