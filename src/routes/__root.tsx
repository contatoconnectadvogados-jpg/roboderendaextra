...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Apenas 5 MINUTOS, esse é o tempo que você gasta para colocar no ar. Sem configuração, sem BM, sem cursos e ebook. Seu Gestor Humano e IA na palma da sua mão!" },
